                                ...
                                <div class="card items">
                                    <div class="card-body">
                                        <div class="items-img position-relative"><img alt=""
                                                                                      ...
                                                                                      src="./images/items/17.jpg"><img
                                                    alt="" class="creator" src="./images/avatar/17.jpg" width="50">
                                        </div>
                                        <a href="./item.html">
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="card items">
                                    <div class="card-body">
                                        <div class="items-img position-relative"><img alt=""
                                                                                      class="img-fluid rounded mb-3"
                                                                                      src="./images/items/18.jpg"><img
                                                    alt="" class="creator" src="./images/avatar/18.jpg" width="50">
                                        </div>
                                        <a href="./item.html">
                                            <h4 class="card-title">Liguid Wave</h4>
                                        </a>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="card items">
                                    <div class="card-body">
                                        <div class="items-img position-relative"><img alt=""
                                                                                      class="img-fluid rounded mb-3"
                                                                                      src="./images/items/19.jpg"><img
                                                    alt="" class="creator" src="./images/avatar/19.jpg" width="50">
                                        </div>
                                        <a href="./item.html">
                                            <h4 class="card-title">Liguid Wave</h4>
                                        </a>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="card items">
                                    <div class="card-body">
                                        <div class="items-img position-relative"><img alt=""
                                                                                      class="img-fluid rounded mb-3"
                                                                                      src="./images/items/20.jpg"><img
                                                    alt="" class="creator" src="./images/avatar/20.jpg" width="50">
                                        </div>
                                        <a href="./item.html">
                                            <h4 class="card-title">Liguid Wave</h4>
                                        </a>
                                ...
                                <div class="card items">
                                    <div class="card-body">
                                        <div class="items-img position-relative"><img alt=""
                                                    ...
                                                    alt="" class="creator" src="./images/avatar/1.jpg" width="50"></div>
                                        <a href="./item.html">
                                            <h4 class="card-title">Liguid Wave</h4>
                                        </a>
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="text-end">
                                                <p class="mb-2">Bid : <strong class="text-primary">0.55 ETH</strong>
                                                </p>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="card items">
                                    <div class="card-body">
                                        <div class="items-img position-relative"><img alt=""
                                                                                      class="img-fluid rounded mb-3"
                                                                                      src="./images/items/14.jpg"><img
                                                    alt="" class="creator" src="./images/avatar/14.jpg" width="50">
                                        </div>
                                        <a href="./item.html">
                                            <h4 class="card-title">Liguid Wave</h4>
                                        </a>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="card items">
                                    <div class="card-body">
                                        <div class="items-img position-relative"><img alt=""
                                                                                      class="img-fluid rounded mb-3"
                                                                                      src="./images/items/15.jpg"><img
                                                    alt="" class="creator" src="./images/avatar/15.jpg" width="50">
                                        </div>
                                        <a href="./item.html">
                                            <h4 class="card-title">Liguid Wave</h4>
                                        </a>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="card items">
                                    <div class="card-body">
                                        <div class="items-img position-relative"><img alt=""
                                                                                      class="img-fluid rounded mb-3"
                                                                                      src="./images/items/16.jpg"><img
                                                    alt="" class="creator" src="./images/avatar/16.jpg" width="50">
                                        </div>
                                        <a href="./item.html">
                                            <h4 class="card-title">Liguid Wave</h4>
                                        </a>
