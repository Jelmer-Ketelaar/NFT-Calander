            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-6">
                    <div class="page-title-content">
                        <h3>Explore</h3>
                        <p class="mb-2">Here you can Explore some NFTs</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card items">
                                <div class="card-body">
                                    <div class="items-img position-relative">
                                        <img alt="" class="img-fluid rounded mb-3" src="./images/items/1.jpg">
                                        <a href="./profile.html"><img alt="" class="creator"
                                                                      src="./images/avatar/1.jpg" width="50"></a>
                                    </div>
                                    <!-- <a href="./item.html">
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                            <div class="card items">
                                <div class="card-body">
                                    <div class="items-img position-relative">
                                        <img alt="" class="img-fluid rounded mb-3" src="./images/items/2.jpg">
                                        <a href="./profile.html"><img alt="" class="creator"
                                                                      src="./images/avatar/2.jpg" width="50"></a>
                                    </div>
                                    <!-- <a href="./item.html">
                                        <h4 class="card-title">Liguid Wave</h4>
                                    </a>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                            <div class="card items">
                                <div class="card-body">
                                    <div class="items-img position-relative">
                                        <img alt="" class="img-fluid rounded mb-3" src="./images/items/3.jpg">
                                        <a href="./profile.html"><img alt="" class="creator"
                                                                      src="./images/avatar/3.jpg" width="50"></a>
                                    </div>
                                    <!-- <a href="./item.html">
                                        <h4 class="card-title">Liguid Wave</h4>
                                    </a>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                            <div class="card items">
                                <div class="card-body">
                                    <div class="items-img position-relative">
                                        <img alt="" class="img-fluid rounded mb-3" src="./images/items/4.jpg">
                                        <a href="./profile.html"><img alt="" class="creator"
                                                                      src="./images/avatar/4.jpg" width="50"></a>
                                    </div>
                                    <!-- <a href="./item.html">
                                        <h4 class="card-title">Liguid Wave</h4>
                                    </a>
                            ...
                            <div class="card items">
                                <div class="card-body">
                                    <div class="items-img position-relative">
                                        ...
                                        <a href="./profile.html"><img alt="" class="creator"
                                                                      src="./images/avatar/5.jpg" width="50"></a>
                                    </div>
                                    <!-- <a href="./item.html">
                                        <h4 class="card-title">Liguid Wave</h4>
                                    </a>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                            <div class="card items">
                                <div class="card-body">
                                    <div class="items-img position-relative">
                                        <img alt="" class="img-fluid rounded mb-3" src="./images/items/6.jpg">
                                        <a href="./profile.html"><img alt="" class="creator"
                                                                      src="./images/avatar/6.jpg" width="50"></a>
                                    </div>
                                    <!-- <a href="./item.html">
                                        <h4 class="card-title">Liguid Wave</h4>
                                    </a>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                            <div class="card items">
                                <div class="card-body">
                                    <div class="items-img position-relative">
                                        <img alt="" class="img-fluid rounded mb-3" src="./images/items/7.jpg">
                                        <a href="./profile.html"><img alt="" class="creator"
                                                                      src="./images/avatar/7.jpg" width="50"></a>
                                    </div>
                                    <!-- <a href="./item.html">
                                        <h4 class="card-title">Liguid Wave</h4>
                                    </a>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                            <div class="card items">
                                <div class="card-body">
                                    <div class="items-img position-relative">
                                        <img alt="" class="img-fluid rounded mb-3" src="./images/items/8.jpg">
                                        <a href="./profile.html"><img alt="" class="creator"
                                                                      src="./images/avatar/8.jpg" width="50"></a>
                                    </div>
                                    <!-- <a href="./item.html">
                                        <h4 class="card-title">Liguid Wave</h4>
                                    </a>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                            <div class="card items">
                                <div class="card-body">
                                    <div class="items-img position-relative">
                                        <img alt="" class="img-fluid rounded mb-3" src="./images/items/9.jpg">
                                        <a href="./profile.html"><img alt="" class="creator"
                                                                      src="./images/avatar/9.jpg" width="50"></a>
                                    </div>
                                    <!-- <a href="./item.html">
                                        <h4 class="card-title">Liguid Wave</h4>
                                    </a>
